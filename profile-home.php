        ...
        foreach($querys as $query) {
            ...
            if($results) {
                while ($row = mysqli_fetch_array($results)) {
                    ...
                    $string = '
                        <div class="col s3">
                            <a class="row" href="/~ckharts/metube/playlist.php?playlistID=' . $playlistID . '">
                                <image src="/~ckharts/metube/images/list_icon.jpg" class="col s12">
                                </image>
                                <div class="col s12">
                                    <h4>' . $playlistName . '</h4>
                                </div>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if($results) {
            ...
            if ($mediaType == "IMAGE") {
                $string = '
                    <div class="col s3">
                        <a href="/~ckharts/metube/view-media.php?mediaID=' . $mediaID . '" class="row">
                            <img  src="/~ckharts/metube/images/img_icon.jpg" class="col s12">
                            <div class="col s12">
                                <h4>' . $title . '</h4><br>
                                <p>' . $desc . '</p>
                            </div>
                ...
                $string = '
                    <div class="col s3">
                        <a href="/~ckharts/metube/view-media.php?mediaID=' . $mediaID . '" class="row">
                            <img  src="/~ckharts/metube/images/video_icon.jpg" class="col s12">
                            <div class="col s12">
                                <h4>' . $title . '</h4><br>
                                <p>' . $desc . '</p>
                            </div>
                ...
                $string = '
                    <div class="col s3">
                        <a href="/~ckharts/metube/view-media.php?mediaID=' . $mediaID . '" class="row">
                            <img  src="/~ckharts/metube/images/audio_icon.jpg" class="col s12">
                            <div class="col s12">
                                <h4>' . $title . '</h4><br>
                                <p>' . $desc . '</p>
                            </div>
    ...
    <body class="blue-grey darken-3" style="overflow: hidden;">
        ...
        <div class="mainwrap">            
            ...
            <div class="rightwindow">
                <iframe src="/~ckharts/metube/contactlist.php"></iframe>
            </div>
        </div>
    </body>
    <script>
