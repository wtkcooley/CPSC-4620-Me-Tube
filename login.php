<?php
  ...
  if (empty($form_errors)) {
    ...
    header("Location: /~cguynup/metube/metube/profile-home.php", true, 301); //redirect to the profile home
    exit;
  }
}
?>
...
<head>
  ...
  <style>
    body {
      background-image: url('/~cguynup/metube/metube/images/main_bg.jpg');
    ...
    <form class="z-depth-5 main col s12" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <a class="z-depth-5 formbtn" href="/~cguynup/metube/metube/createaccnt.php">Create Account</a>
        </div>
        <div class="row">
          <a href="/~cguynup/metube/metube/browse.php">
            <p6>Return home...</p6>
          </a>
        </div>
      </form>
